...
export type ChatMessage={id:string;body:string|null;direction:string;source:string;type:string;mediaUrl:string|null;status:string;createdAt:string;sentAt:string|null};
